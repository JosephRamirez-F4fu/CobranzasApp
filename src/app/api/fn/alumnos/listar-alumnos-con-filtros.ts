...
export interface ListarAlumnosConFiltros$Params {
...
export function listarAlumnosConFiltros(http: HttpClient, rootUrl: string, params?: ListarAlumnosConFiltros$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponsePageAlumnoResponse>> {
  const rb = new RequestBuilder(rootUrl, listarAlumnosConFiltros.PATH, 'get');
  if (params) {
...
listarAlumnosConFiltros.PATH = '/student';
