...
export interface ListarUsuariosConFiltros$Params {
...
export function listarUsuariosConFiltros(http: HttpClient, rootUrl: string, params?: ListarUsuariosConFiltros$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponsePageUsuarioResponse>> {
  const rb = new RequestBuilder(rootUrl, listarUsuariosConFiltros.PATH, 'get');
  if (params) {
...
listarUsuariosConFiltros.PATH = '/usuario';
